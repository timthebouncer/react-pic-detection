...
const styleList = [{id:1,name:'綜包PC圖'},{id:2,name:'綜包PC圖 - 國際化'},{id:3,name:'棋牌內頁圖'},{id:4,name:'綜包H5/APP'},
  ...
  {id:19,name:'廠商圖'},{id:20,name:'熱門圖'},{id:21,name:'二級圖標'},{id:22,name:'一級廠商LOGO'},
]
  ...
  return (
    <div className={styles.App}>
        <div className={styles.container}>
            <SearchBar fileList={fileList} state={state} stateStyle={stateStyle} sizeListState={sizeListState} result={result} setResult={setResult} />
